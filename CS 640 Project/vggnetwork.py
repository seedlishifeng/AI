...
class Vggnetwork:
    ...
    def __init__(self, vgg_npy_path=None, trainable=True, use_latter_layer = True, dropout=0.5, num_class = 1000):
    ...
    def build(self, rgb, train_mode=None):
        ...
        self.relu6 = tf.nn.relu(self.ffc6c6)
    ...
    def avg_pool(self, bottom, name):
        if(name == 'pool4') and self.trainable:
    ...
    def get_var(self, initial_value, name, idx, var_name):
        ...
        if self.trainable and ~self.use_latter_layer:
